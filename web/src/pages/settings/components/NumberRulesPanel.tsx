...
// 工具函数：解析生成规则示例预览
function generatePreviewNumber(rule: API.NumberRule): { text: string; isDynamicType?: boolean } {
  ...
  const columns: ColumnsType<API.NumberRule> = [
    ...
    },
    {
      ...
      render: (prefix, record) => {
        ...
        if (meta?.numValue === 1) {
          return (
            <Tag color="blue" style={{ fontFamily: 'ui-monospace, monospace', fontWeight: 600, margin: 0 }}>
              {prefix ? `${prefix}-{业务代码}` : '{业务代码}'}
            </Tag>
          );
        }
        return (
          <Tag style={{ fontFamily: 'ui-monospace, monospace', fontWeight: 600, color: prefix ? '#1677ff' : '#8c8c8c', margin: 0 }}>
            {prefix || '无'}
          </Tag>
        );
      },
              ...
              return (
                <Col xs={24} sm={12} md={8} lg={6} key={rule.id || rule.documentType}>
                  ...
                  >
                      ...
                      >
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                          ...
                          {meta.numValue === 1 ? (
                            ...
                            <Tag style={{ fontFamily: 'ui-monospace, monospace', fontWeight: 600, color: rule.prefix ? '#1677ff' : '#8c8c8c', margin: 0 }}>
                              {rule.prefix || '无'}
                            </Tag>
                          )}
                        </div>
                        {meta.businessCodes && (
                          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            ...
                            <span style={{ fontFamily: 'ui-monospace, monospace', color: '#262626', fontSize: 11 }}>
                    ...
                    <div>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 11, color: '#8c8c8c', marginBottom: 4 }}>
                        <span>单号示例预览：</span>
                        {sample.isDynamicType && (
                          <span style={{ fontSize: 11, color: '#1677ff' }}>SE 为示例流向</span>
                        )}
                      </div>
                      <div
                        style={{
