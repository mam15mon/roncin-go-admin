...
func Authorization(usecase *biz.AuthUsecase, policy *biz.SessionPolicy) middleware.Middleware {
	...
	permissionOperations := map[string]permissionRule{
		...
		adminv1.OperationAdminServiceAuthorizeWeComUser:                               {key: access.UserManage, scope: biz.DataScopeAll},
		...
		adminv1.OperationAdminServiceListOrganizationRoles:                            {key: access.RoleManage, scope: biz.DataScopeAll},
		...
		masterdatav1.OperationMasterDataServiceListAdministrativeRegions:              {key: access.MasterDataRead, scope: biz.DataScopeOrganization},
		...
		masterdatav1.OperationMasterDataServiceListPorts:                              {key: access.MasterDataRead, scope: biz.DataScopeOrganization},
		masterdatav1.OperationMasterDataServiceCreatePort:                             {key: access.MasterDataManage, scope: biz.DataScopeOrganization},
		masterdatav1.OperationMasterDataServiceUpdatePort:                             {key: access.MasterDataManage, scope: biz.DataScopeOrganization},
		masterdatav1.OperationMasterDataServiceListAirports:                           {key: access.MasterDataRead, scope: biz.DataScopeOrganization},
		masterdatav1.OperationMasterDataServiceCreateAirport:                          {key: access.MasterDataManage, scope: biz.DataScopeOrganization},
		masterdatav1.OperationMasterDataServiceUpdateAirport:                          {key: access.MasterDataManage, scope: biz.DataScopeOrganization},
		masterdatav1.OperationMasterDataServiceListAirlines:                           {key: access.MasterDataRead, scope: biz.DataScopeOrganization},
		masterdatav1.OperationMasterDataServiceCreateAirline:                          {key: access.MasterDataManage, scope: biz.DataScopeOrganization},
		masterdatav1.OperationMasterDataServiceUpdateAirline:                          {key: access.MasterDataManage, scope: biz.DataScopeOrganization},
		masterdatav1.OperationMasterDataServiceListShippingLines:                      {key: access.MasterDataRead, scope: biz.DataScopeOrganization},
		masterdatav1.OperationMasterDataServiceCreateShippingLine:                     {key: access.MasterDataManage, scope: biz.DataScopeOrganization},
		masterdatav1.OperationMasterDataServiceUpdateShippingLine:                     {key: access.MasterDataManage, scope: biz.DataScopeOrganization},
		...
		orderv1.OperationOrderShippingDocumentServiceListShippingDocuments:            {key: access.OrderRead, scope: biz.DataScopeOrganization},
		orderv1.OperationOrderShippingDocumentServiceAddShippingDocument:              {key: access.OrderManage, scope: biz.DataScopeOrganization},
