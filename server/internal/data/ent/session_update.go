...
func (_u *SessionUpdate) SetOrganizationID(v uuid.UUID) *SessionUpdate {
	_u.mutation.SetOrganizationID(v)
	return _u
}

// SetNillableOrganizationID sets the "organization_id" field if the given value is not nil.
func (_u *SessionUpdate) SetNillableOrganizationID(v *uuid.UUID) *SessionUpdate {
	if v != nil {
...
func (_u *SessionUpdate) SetOrganization(v *Organization) *SessionUpdate {
...
func (_u *SessionUpdate) ClearOrganization() *SessionUpdate {
...
func (_u *SessionUpdate) check() error {
	...
	if _u.mutation.OrganizationCleared() && len(_u.mutation.OrganizationIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Session.organization"`)
	}
	return nil
}
...
// SetOrganizationID sets the "organization_id" field.
func (_u *SessionUpdateOne) SetOrganizationID(v uuid.UUID) *SessionUpdateOne {
	_u.mutation.SetOrganizationID(v)
	return _u
}

// SetNillableOrganizationID sets the "organization_id" field if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableOrganizationID(v *uuid.UUID) *SessionUpdateOne {
	if v != nil {
		_u.SetOrganizationID(*v)
	}
	return _u
...
// SetOrganization sets the "organization" edge to the Organization entity.
func (_u *SessionUpdateOne) SetOrganization(v *Organization) *SessionUpdateOne {
	return _u.SetOrganizationID(v.ID)
}
...
// ClearOrganization clears the "organization" edge to the Organization entity.
func (_u *SessionUpdateOne) ClearOrganization() *SessionUpdateOne {
	_u.mutation.ClearOrganization()
	return _u
}
