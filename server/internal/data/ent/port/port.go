...
const (
	...
	// FieldTransportModes holds the string denoting the transport_modes field in the database.
	FieldTransportModes = "transport_modes"
...
var (
	...
	// UnLocodeValidator is a validator for the "un_locode" field. It is called by the builders before save.
	UnLocodeValidator func(string) error
