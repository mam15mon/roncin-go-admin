...
func (User) Edges() []ent.Edge {
	return []ent.Edge{
		...
		edge.To("confirmed_finance_nettings", FinanceNetting.Type),
		edge.To("cancelled_finance_nettings", FinanceNetting.Type),
		edge.To("reversed_finance_nettings", FinanceNetting.Type),
