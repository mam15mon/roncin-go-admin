...
func (Order) Fields() []ent.Field {
	return []ent.Field{
		...
		field.String("shipper_short_name").Default("").MaxLen(200),
		field.String("consignee_short_name").Default("").MaxLen(200),
		field.UUID("shipping_line_id", uuid.Nil).Optional().Nillable(),
...
func (Order) Edges() []ent.Edge {
	return []ent.Edge{
		...
		edge.From("shipping_line", ShippingLine.Type).Ref("orders").Field("shipping_line_id").Unique(),
		...
		edge.To("fee_supplement_requests", OrderFeeSupplementRequest.Type),
