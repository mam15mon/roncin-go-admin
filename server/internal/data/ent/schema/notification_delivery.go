...
func (NotificationDelivery) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Enum("template").Values("ORDER_PERSONNEL_ASSIGNED", "USER_AUTHORIZED", "DINGTALK_REGISTRATION_PENDING", "DINGTALK_REGISTRATION_REJECTED", "DINGTALK_INVITATION_ACTIVATED").Immutable(),
