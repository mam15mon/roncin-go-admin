...
func (SeaMasterBillOrderLink) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Enum("document_structure").Values("DIRECT", "HOUSE").Default("HOUSE"),
...
func (SeaMasterBillOrderLink) Edges() []ent.Edge {
	return []ent.Edge{
		...
		edge.From("transport_execution", SeaTransportExecution.Type).Ref("order_links").Field("transport_execution_id").Unique().Required(),
