...
func (NumberRule) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Enum("document_type").Values("order", "bill", "bill_batch", "quotation", "write_off", "receipt_payment", "contract", "internal_reference", "customer_reference", "house_bill", "coload_house_bill", "invoice", "freight_rate", "commission", "netting"),
