	...
	FinanceCommissionsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{FinanceCommissionsColumns[34]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "finance_commissions_users_confirmed_finance_commissions",
				Columns:    []*schema.Column{FinanceCommissionsColumns[35]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "finance_commissions_users_paid_finance_commissions",
				Columns:    []*schema.Column{FinanceCommissionsColumns[36]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{FinanceCommissionsColumns[33], FinanceCommissionsColumns[3]},
			},
			{
				Name:    "financecommission_organization_id_idempotency_key",
				Unique:  true,
				Columns: []*schema.Column{FinanceCommissionsColumns[33], FinanceCommissionsColumns[4]},
			},
			{
				Name:    "financecommission_verification_id_employee_id_status",
				Unique:  false,
				Columns: []*schema.Column{FinanceCommissionsColumns[32], FinanceCommissionsColumns[34], FinanceCommissionsColumns[16]},
			},
			{
				Name:    "financecommission_organization_id_status_created_at",
				Unique:  false,
				Columns: []*schema.Column{FinanceCommissionsColumns[33], FinanceCommissionsColumns[16], FinanceCommissionsColumns[1]},
			},
		},
	}
