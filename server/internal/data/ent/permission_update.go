...
func (_u *PermissionUpdate) SetGroup(v string) *PermissionUpdate {
	_u.mutation.SetGroup(v)
	return _u
}

// SetNillableGroup sets the "group" field if the given value is not nil.
func (_u *PermissionUpdate) SetNillableGroup(v *string) *PermissionUpdate {
	if v != nil {
		_u.SetGroup(*v)
	}
	return _u
...
// SetGroup sets the "group" field.
func (_u *PermissionUpdateOne) SetGroup(v string) *PermissionUpdateOne {
	_u.mutation.SetGroup(v)
	return _u
}

// SetNillableGroup sets the "group" field if the given value is not nil.
func (_u *PermissionUpdateOne) SetNillableGroup(v *string) *PermissionUpdateOne {
	if v != nil {
		_u.SetGroup(*v)
	}
	return _u
