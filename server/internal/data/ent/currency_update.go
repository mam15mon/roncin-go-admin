...
func (_u *CurrencyUpdate) SetMinorUnit(v int) *CurrencyUpdate {
	_u.mutation.ResetMinorUnit()
	_u.mutation.SetMinorUnit(v)
	return _u
}

// SetNillableMinorUnit sets the "minor_unit" field if the given value is not nil.
func (_u *CurrencyUpdate) SetNillableMinorUnit(v *int) *CurrencyUpdate {
	if v != nil {
		_u.SetMinorUnit(*v)
	}
	return _u
...
// AddMinorUnit adds value to the "minor_unit" field.
func (_u *CurrencyUpdate) AddMinorUnit(v int) *CurrencyUpdate {
	_u.mutation.AddMinorUnit(v)
	return _u
}
...
func (_u *CurrencyUpdate) check() error {
	...
	if v, ok := _u.mutation.MinorUnit(); ok {
...
func (_u *CurrencyUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.MinorUnit(); ok {
		_spec.SetField(currency.FieldMinorUnit, field.TypeInt, value)
	}
	if value, ok := _u.mutation.AddedMinorUnit(); ok {
		_spec.AddField(currency.FieldMinorUnit, field.TypeInt, value)
	}
...
// SetMinorUnit sets the "minor_unit" field.
func (_u *CurrencyUpdateOne) SetMinorUnit(v int) *CurrencyUpdateOne {
	_u.mutation.ResetMinorUnit()
	_u.mutation.SetMinorUnit(v)
	return _u
}
...
// SetNillableMinorUnit sets the "minor_unit" field if the given value is not nil.
func (_u *CurrencyUpdateOne) SetNillableMinorUnit(v *int) *CurrencyUpdateOne {
	if v != nil {
		_u.SetMinorUnit(*v)
	}
	return _u
...
// AddMinorUnit adds value to the "minor_unit" field.
func (_u *CurrencyUpdateOne) AddMinorUnit(v int) *CurrencyUpdateOne {
	_u.mutation.AddMinorUnit(v)
	return _u
}
