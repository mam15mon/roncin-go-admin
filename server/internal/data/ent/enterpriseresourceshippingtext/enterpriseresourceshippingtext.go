...
const (
	// Label holds the string label denoting the enterpriseresourceshippingtext type in the database.
	Label = "enterprise_resource_shipping_text"
	...
	// Table holds the table name of the enterpriseresourceshippingtext in the database.
	Table = "enterprise_resource_shipping_texts"
	// ResourceTable is the table that holds the resource relation/edge.
	ResourceTable = "enterprise_resource_shipping_texts"
...
// Columns holds all SQL columns for enterpriseresourceshippingtext fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the EnterpriseResourceShippingText queries.
