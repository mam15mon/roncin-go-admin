...
type OrganizationEdges struct {
	...
	// FinanceNettings holds the value of the finance_nettings edge.
	FinanceNettings []*FinanceNetting `json:"finance_nettings,omitempty"`
	...
	// FinanceCommissionRuleAssignments holds the value of the finance_commission_rule_assignments edge.
	FinanceCommissionRuleAssignments []*FinanceCommissionRuleAssignment `json:"finance_commission_rule_assignments,omitempty"`
	...
	// OrderFeeSupplementRequests holds the value of the order_fee_supplement_requests edge.
	OrderFeeSupplementRequests []*OrderFeeSupplementRequest `json:"order_fee_supplement_requests,omitempty"`
...
// FinanceNettingsOrErr returns the FinanceNettings value or an error if the edge
// was not loaded in eager-loading.
func (e OrganizationEdges) FinanceNettingsOrErr() ([]*FinanceNetting, error) {
	if e.loadedTypes[28] {
		return e.FinanceNettings, nil
	}
	return nil, &NotLoadedError{edge: "finance_nettings"}
}
...
// was not loaded in eager-loading.
func (e OrganizationEdges) FinanceCommissionRuleAssignmentsOrErr() ([]*FinanceCommissionRuleAssignment, error) {
	if e.loadedTypes[33] {
...
// was not loaded in eager-loading.
func (e OrganizationEdges) FinanceCommissionApplicationsOrErr() ([]*FinanceCommissionApplication, error) {
	if e.loadedTypes[34] {
...
// was not loaded in eager-loading.
func (e OrganizationEdges) FinanceCommissionApplicationLinesOrErr() ([]*FinanceCommissionApplicationLine, error) {
	if e.loadedTypes[35] {
...
// QueryFinanceNettings queries the "finance_nettings" edge of the Organization entity.
func (_m *Organization) QueryFinanceNettings() *FinanceNettingQuery {
	return NewOrganizationClient(_m.config).QueryFinanceNettings(_m)
}
...
// QueryFinanceCommissionRuleAssignments queries the "finance_commission_rule_assignments" edge of the Organization entity.
func (_m *Organization) QueryFinanceCommissionRuleAssignments() *FinanceCommissionRuleAssignmentQuery {
	return NewOrganizationClient(_m.config).QueryFinanceCommissionRuleAssignments(_m)
}

// QueryFinanceCommissionApplications queries the "finance_commission_applications" edge of the Organization entity.
func (_m *Organization) QueryFinanceCommissionApplications() *FinanceCommissionApplicationQuery {
	return NewOrganizationClient(_m.config).QueryFinanceCommissionApplications(_m)
}

// QueryFinanceCommissionApplicationLines queries the "finance_commission_application_lines" edge of the Organization entity.
func (_m *Organization) QueryFinanceCommissionApplicationLines() *FinanceCommissionApplicationLineQuery {
	return NewOrganizationClient(_m.config).QueryFinanceCommissionApplicationLines(_m)
}
...
// QueryOrderFeeSupplementRequests queries the "order_fee_supplement_requests" edge of the Organization entity.
func (_m *Organization) QueryOrderFeeSupplementRequests() *OrderFeeSupplementRequestQuery {
	return NewOrganizationClient(_m.config).QueryOrderFeeSupplementRequests(_m)
}
