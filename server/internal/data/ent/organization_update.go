...
func (_u *OrganizationUpdate) AddSeaHouseBillIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.AddSeaHouseBillIDs(ids...)
	return _u
}

// AddSeaHouseBills adds the "sea_house_bills" edges to the SeaHouseBill entity.
func (_u *OrganizationUpdate) AddSeaHouseBills(v ...*SeaHouseBill) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddIssuedSeaHouseBillIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) AddIssuedSeaHouseBills(v ...*SeaHouseBill) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddOrderCargoItemIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.AddOrderCargoItemIDs(ids...)
	return _u
}

// AddOrderCargoItems adds the "order_cargo_items" edges to the OrderCargoItem entity.
func (_u *OrganizationUpdate) AddOrderCargoItems(v ...*OrderCargoItem) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddOrderCargoItemIDs(ids...)
}

// AddOrderContainerIDs adds the "order_containers" edge to the OrderContainer entity by IDs.
func (_u *OrganizationUpdate) AddOrderContainerIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.AddOrderContainerIDs(ids...)
	return _u
}

// AddOrderContainers adds the "order_containers" edges to the OrderContainer entity.
func (_u *OrganizationUpdate) AddOrderContainers(v ...*OrderContainer) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddOrderContainerIDs(ids...)
}
...
func (_u *OrganizationUpdate) AddFinanceCommissionRuleAssignmentIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) AddFinanceCommissionRuleAssignments(v ...*FinanceCommissionRuleAssignment) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddFinanceCommissionApplicationIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.AddFinanceCommissionApplicationIDs(ids...)
	return _u
}
...
func (_u *OrganizationUpdate) AddFinanceCommissionApplications(v ...*FinanceCommissionApplication) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddFinanceCommissionApplicationIDs(ids...)
}
...
func (_u *OrganizationUpdate) AddFinanceCommissionApplicationLineIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.AddFinanceCommissionApplicationLineIDs(ids...)
	return _u
}
...
func (_u *OrganizationUpdate) AddFinanceCommissionApplicationLines(v ...*FinanceCommissionApplicationLine) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddFinanceCommissionApplicationLineIDs(ids...)
}
...
func (_u *OrganizationUpdate) AddAttachmentAssetIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.AddAttachmentAssetIDs(ids...)
	return _u
}

// AddAttachmentAssets adds the "attachment_assets" edges to the OrderAttachmentAsset entity.
func (_u *OrganizationUpdate) AddAttachmentAssets(v ...*OrderAttachmentAsset) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddAttachmentAssetIDs(ids...)
}

// AddSeaOrderSplitEventIDs adds the "sea_order_split_events" edge to the SeaOrderSplitEvent entity by IDs.
func (_u *OrganizationUpdate) AddSeaOrderSplitEventIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) AddSeaOrderSplitEvents(v ...*SeaOrderSplitEvent) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddSeaOrderSplitResultIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) AddSeaOrderSplitResults(v ...*SeaOrderSplitResult) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddSeaOrderReassignmentEventIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) AddSeaOrderReassignmentEvents(v ...*SeaOrderReassignmentEvent) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddOrderLockRecordIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.AddOrderLockRecordIDs(ids...)
	return _u
}

// AddOrderLockRecords adds the "order_lock_records" edges to the OrderLockRecord entity.
func (_u *OrganizationUpdate) AddOrderLockRecords(v ...*OrderLockRecord) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddOrderLockHouseBillSnapshotIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) AddOrderLockHouseBillSnapshots(v ...*OrderLockHouseBillSnapshot) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddOrderLockHouseBillSnapshotIDs(ids...)
}

// AddOrderUnlockRequestIDs adds the "order_unlock_requests" edge to the OrderUnlockRequest entity by IDs.
func (_u *OrganizationUpdate) AddOrderUnlockRequestIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) AddOrderUnlockRequests(v ...*OrderUnlockRequest) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddSeaMasterBillVersionIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) AddSeaMasterBillVersions(v ...*SeaMasterBillVersion) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddSeaHouseBillVersionIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) AddSeaHouseBillVersions(v ...*SeaHouseBillVersion) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddIssuedSeaHouseBillVersionIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.AddIssuedSeaHouseBillVersionIDs(ids...)
	return _u
}

// AddIssuedSeaHouseBillVersions adds the "issued_sea_house_bill_versions" edges to the SeaHouseBillVersion entity.
func (_u *OrganizationUpdate) AddIssuedSeaHouseBillVersions(v ...*SeaHouseBillVersion) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddIssuedSeaHouseBillVersionIDs(ids...)
}

// AddDingtalkApprovalDispatchIDs adds the "dingtalk_approval_dispatches" edge to the DingTalkApprovalDispatch entity by IDs.
func (_u *OrganizationUpdate) AddDingtalkApprovalDispatchIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.AddDingtalkApprovalDispatchIDs(ids...)
	return _u
}

// AddDingtalkApprovalDispatches adds the "dingtalk_approval_dispatches" edges to the DingTalkApprovalDispatch entity.
func (_u *OrganizationUpdate) AddDingtalkApprovalDispatches(v ...*DingTalkApprovalDispatch) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddDingtalkApprovalDispatchIDs(ids...)
}

// AddSeaDocumentVoidEventIDs adds the "sea_document_void_events" edge to the SeaDocumentVoidEvent entity by IDs.
func (_u *OrganizationUpdate) AddSeaDocumentVoidEventIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) AddSeaDocumentVoidEvents(v ...*SeaDocumentVoidEvent) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddSeaTransportExecutionVersionIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) AddSeaTransportExecutionVersions(v ...*SeaTransportExecutionVersion) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddSeaDocumentModeChangeEventIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) AddSeaDocumentModeChangeEvents(v ...*SeaDocumentModeChangeEvent) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddSeaSharedContainerIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.AddSeaSharedContainerIDs(ids...)
	return _u
}

// AddSeaSharedContainers adds the "sea_shared_containers" edges to the SeaSharedContainer entity.
func (_u *OrganizationUpdate) AddSeaSharedContainers(v ...*SeaSharedContainer) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddSeaSharedContainerIDs(ids...)
}
...
func (_u *OrganizationUpdate) AddSeaSharedContainerAllocationIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.AddSeaSharedContainerAllocationIDs(ids...)
	return _u
}
...
func (_u *OrganizationUpdate) AddSeaSharedContainerAllocations(v ...*SeaSharedContainerAllocation) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) ClearIssuedSeaHouseBills() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveIssuedSeaHouseBillIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveIssuedSeaHouseBills(v ...*SeaHouseBill) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearOrderCargoItems clears all "order_cargo_items" edges to the OrderCargoItem entity.
func (_u *OrganizationUpdate) ClearOrderCargoItems() *OrganizationUpdate {
	_u.mutation.ClearOrderCargoItems()
	return _u
}

// RemoveOrderCargoItemIDs removes the "order_cargo_items" edge to OrderCargoItem entities by IDs.
func (_u *OrganizationUpdate) RemoveOrderCargoItemIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.RemoveOrderCargoItemIDs(ids...)
	return _u
}

// RemoveOrderCargoItems removes "order_cargo_items" edges to OrderCargoItem entities.
func (_u *OrganizationUpdate) RemoveOrderCargoItems(v ...*OrderCargoItem) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveOrderCargoItemIDs(ids...)
}

// ClearOrderContainers clears all "order_containers" edges to the OrderContainer entity.
func (_u *OrganizationUpdate) ClearOrderContainers() *OrganizationUpdate {
	_u.mutation.ClearOrderContainers()
	return _u
}

// RemoveOrderContainerIDs removes the "order_containers" edge to OrderContainer entities by IDs.
func (_u *OrganizationUpdate) RemoveOrderContainerIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.RemoveOrderContainerIDs(ids...)
	return _u
}

// RemoveOrderContainers removes "order_containers" edges to OrderContainer entities.
func (_u *OrganizationUpdate) RemoveOrderContainers(v ...*OrderContainer) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveOrderContainerIDs(ids...)
}
...
func (_u *OrganizationUpdate) ClearFinanceCommissionRuleAssignments() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveFinanceCommissionRuleAssignmentIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveFinanceCommissionRuleAssignments(v ...*FinanceCommissionRuleAssignment) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearFinanceCommissionApplications clears all "finance_commission_applications" edges to the FinanceCommissionApplication entity.
func (_u *OrganizationUpdate) ClearFinanceCommissionApplications() *OrganizationUpdate {
	_u.mutation.ClearFinanceCommissionApplications()
	return _u
}

// RemoveFinanceCommissionApplicationIDs removes the "finance_commission_applications" edge to FinanceCommissionApplication entities by IDs.
func (_u *OrganizationUpdate) RemoveFinanceCommissionApplicationIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.RemoveFinanceCommissionApplicationIDs(ids...)
	return _u
}

// RemoveFinanceCommissionApplications removes "finance_commission_applications" edges to FinanceCommissionApplication entities.
func (_u *OrganizationUpdate) RemoveFinanceCommissionApplications(v ...*FinanceCommissionApplication) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveFinanceCommissionApplicationIDs(ids...)
}

// ClearFinanceCommissionApplicationLines clears all "finance_commission_application_lines" edges to the FinanceCommissionApplicationLine entity.
func (_u *OrganizationUpdate) ClearFinanceCommissionApplicationLines() *OrganizationUpdate {
	_u.mutation.ClearFinanceCommissionApplicationLines()
	return _u
}

// RemoveFinanceCommissionApplicationLineIDs removes the "finance_commission_application_lines" edge to FinanceCommissionApplicationLine entities by IDs.
func (_u *OrganizationUpdate) RemoveFinanceCommissionApplicationLineIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.RemoveFinanceCommissionApplicationLineIDs(ids...)
	return _u
}

// RemoveFinanceCommissionApplicationLines removes "finance_commission_application_lines" edges to FinanceCommissionApplicationLine entities.
func (_u *OrganizationUpdate) RemoveFinanceCommissionApplicationLines(v ...*FinanceCommissionApplicationLine) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveFinanceCommissionApplicationLineIDs(ids...)
}
...
// ClearAttachmentAssets clears all "attachment_assets" edges to the OrderAttachmentAsset entity.
func (_u *OrganizationUpdate) ClearAttachmentAssets() *OrganizationUpdate {
	_u.mutation.ClearAttachmentAssets()
	return _u
}

// RemoveAttachmentAssetIDs removes the "attachment_assets" edge to OrderAttachmentAsset entities by IDs.
func (_u *OrganizationUpdate) RemoveAttachmentAssetIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.RemoveAttachmentAssetIDs(ids...)
	return _u
}

// RemoveAttachmentAssets removes "attachment_assets" edges to OrderAttachmentAsset entities.
func (_u *OrganizationUpdate) RemoveAttachmentAssets(v ...*OrderAttachmentAsset) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveAttachmentAssetIDs(ids...)
}

// ClearSeaOrderSplitEvents clears all "sea_order_split_events" edges to the SeaOrderSplitEvent entity.
func (_u *OrganizationUpdate) ClearSeaOrderSplitEvents() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaOrderSplitEventIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaOrderSplitEvents(v ...*SeaOrderSplitEvent) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) ClearSeaOrderSplitResults() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaOrderSplitResultIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaOrderSplitResults(v ...*SeaOrderSplitResult) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) ClearSeaOrderReassignmentEvents() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaOrderReassignmentEventIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaOrderReassignmentEvents(v ...*SeaOrderReassignmentEvent) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) ClearOrderLockRecords() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveOrderLockRecordIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveOrderLockRecords(v ...*OrderLockRecord) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) ClearOrderLockHouseBillSnapshots() *OrganizationUpdate {
	_u.mutation.ClearOrderLockHouseBillSnapshots()
	return _u
}

// RemoveOrderLockHouseBillSnapshotIDs removes the "order_lock_house_bill_snapshots" edge to OrderLockHouseBillSnapshot entities by IDs.
func (_u *OrganizationUpdate) RemoveOrderLockHouseBillSnapshotIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.RemoveOrderLockHouseBillSnapshotIDs(ids...)
	return _u
}

// RemoveOrderLockHouseBillSnapshots removes "order_lock_house_bill_snapshots" edges to OrderLockHouseBillSnapshot entities.
func (_u *OrganizationUpdate) RemoveOrderLockHouseBillSnapshots(v ...*OrderLockHouseBillSnapshot) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveOrderLockHouseBillSnapshotIDs(ids...)
}

// ClearOrderUnlockRequests clears all "order_unlock_requests" edges to the OrderUnlockRequest entity.
func (_u *OrganizationUpdate) ClearOrderUnlockRequests() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveOrderUnlockRequestIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveOrderUnlockRequests(v ...*OrderUnlockRequest) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) ClearSeaMasterBillVersions() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaMasterBillVersionIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaMasterBillVersions(v ...*SeaMasterBillVersion) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) ClearSeaHouseBillVersions() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaHouseBillVersionIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaHouseBillVersions(v ...*SeaHouseBillVersion) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearIssuedSeaHouseBillVersions clears all "issued_sea_house_bill_versions" edges to the SeaHouseBillVersion entity.
func (_u *OrganizationUpdate) ClearIssuedSeaHouseBillVersions() *OrganizationUpdate {
	_u.mutation.ClearIssuedSeaHouseBillVersions()
	return _u
}

// RemoveIssuedSeaHouseBillVersionIDs removes the "issued_sea_house_bill_versions" edge to SeaHouseBillVersion entities by IDs.
func (_u *OrganizationUpdate) RemoveIssuedSeaHouseBillVersionIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.RemoveIssuedSeaHouseBillVersionIDs(ids...)
	return _u
}

// RemoveIssuedSeaHouseBillVersions removes "issued_sea_house_bill_versions" edges to SeaHouseBillVersion entities.
func (_u *OrganizationUpdate) RemoveIssuedSeaHouseBillVersions(v ...*SeaHouseBillVersion) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveIssuedSeaHouseBillVersionIDs(ids...)
}

// ClearDingtalkApprovalDispatches clears all "dingtalk_approval_dispatches" edges to the DingTalkApprovalDispatch entity.
func (_u *OrganizationUpdate) ClearDingtalkApprovalDispatches() *OrganizationUpdate {
	_u.mutation.ClearDingtalkApprovalDispatches()
	return _u
}

// RemoveDingtalkApprovalDispatchIDs removes the "dingtalk_approval_dispatches" edge to DingTalkApprovalDispatch entities by IDs.
func (_u *OrganizationUpdate) RemoveDingtalkApprovalDispatchIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.RemoveDingtalkApprovalDispatchIDs(ids...)
	return _u
}

// RemoveDingtalkApprovalDispatches removes "dingtalk_approval_dispatches" edges to DingTalkApprovalDispatch entities.
func (_u *OrganizationUpdate) RemoveDingtalkApprovalDispatches(v ...*DingTalkApprovalDispatch) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveDingtalkApprovalDispatchIDs(ids...)
}

// ClearSeaDocumentVoidEvents clears all "sea_document_void_events" edges to the SeaDocumentVoidEvent entity.
func (_u *OrganizationUpdate) ClearSeaDocumentVoidEvents() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaDocumentVoidEventIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaDocumentVoidEvents(v ...*SeaDocumentVoidEvent) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) ClearSeaTransportExecutionVersions() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaTransportExecutionVersionIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaTransportExecutionVersions(v ...*SeaTransportExecutionVersion) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) ClearSeaDocumentModeChangeEvents() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaDocumentModeChangeEventIDs(ids ...uuid.UUID) *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveSeaDocumentModeChangeEvents(v ...*SeaDocumentModeChangeEvent) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSeaSharedContainers clears all "sea_shared_containers" edges to the SeaSharedContainer entity.
func (_u *OrganizationUpdate) ClearSeaSharedContainers() *OrganizationUpdate {
	_u.mutation.ClearSeaSharedContainers()
	return _u
}

// RemoveSeaSharedContainerIDs removes the "sea_shared_containers" edge to SeaSharedContainer entities by IDs.
func (_u *OrganizationUpdate) RemoveSeaSharedContainerIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.RemoveSeaSharedContainerIDs(ids...)
	return _u
}

// RemoveSeaSharedContainers removes "sea_shared_containers" edges to SeaSharedContainer entities.
func (_u *OrganizationUpdate) RemoveSeaSharedContainers(v ...*SeaSharedContainer) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveSeaSharedContainerIDs(ids...)
}

// ClearSeaSharedContainerAllocations clears all "sea_shared_container_allocations" edges to the SeaSharedContainerAllocation entity.
func (_u *OrganizationUpdate) ClearSeaSharedContainerAllocations() *OrganizationUpdate {
	_u.mutation.ClearSeaSharedContainerAllocations()
	return _u
}

// RemoveSeaSharedContainerAllocationIDs removes the "sea_shared_container_allocations" edge to SeaSharedContainerAllocation entities by IDs.
func (_u *OrganizationUpdate) RemoveSeaSharedContainerAllocationIDs(ids ...uuid.UUID) *OrganizationUpdate {
	_u.mutation.RemoveSeaSharedContainerAllocationIDs(ids...)
	return _u
}

// RemoveSeaSharedContainerAllocations removes "sea_shared_container_allocations" edges to SeaSharedContainerAllocation entities.
func (_u *OrganizationUpdate) RemoveSeaSharedContainerAllocations(v ...*SeaSharedContainerAllocation) *OrganizationUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.OrderCargoItemsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedOrderCargoItemsIDs(); len(nodes) > 0 && !_u.mutation.OrderCargoItemsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.OrderCargoItemsTable,
	...
	if nodes := _u.mutation.OrderCargoItemsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.OrderCargoItemsTable,
	...
	if _u.mutation.OrderContainersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedOrderContainersIDs(); len(nodes) > 0 && !_u.mutation.OrderContainersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.OrderContainersTable,
	...
	if nodes := _u.mutation.OrderContainersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.OrderContainersTable,
	...
	if _u.mutation.FinanceCommissionRuleAssignmentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.FinanceCommissionRuleAssignmentsTable,
			Columns: []string{organization.FinanceCommissionRuleAssignmentsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if _u.mutation.FinanceCommissionApplicationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedFinanceCommissionApplicationsIDs(); len(nodes) > 0 && !_u.mutation.FinanceCommissionApplicationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.FinanceCommissionApplicationsTable,
	...
	if nodes := _u.mutation.FinanceCommissionApplicationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.FinanceCommissionApplicationsTable,
	...
	if _u.mutation.FinanceCommissionApplicationLinesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedFinanceCommissionApplicationLinesIDs(); len(nodes) > 0 && !_u.mutation.FinanceCommissionApplicationLinesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.FinanceCommissionApplicationLinesTable,
	...
	if nodes := _u.mutation.FinanceCommissionApplicationLinesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.FinanceCommissionApplicationLinesTable,
	...
	if _u.mutation.AttachmentAssetsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedAttachmentAssetsIDs(); len(nodes) > 0 && !_u.mutation.AttachmentAssetsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.AttachmentAssetsTable,
	...
	if nodes := _u.mutation.AttachmentAssetsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.AttachmentAssetsTable,
	...
	if nodes := _u.mutation.RemovedOrderLockHouseBillSnapshotsIDs(); len(nodes) > 0 && !_u.mutation.OrderLockHouseBillSnapshotsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.OrderLockHouseBillSnapshotsTable,
	...
	if nodes := _u.mutation.OrderLockHouseBillSnapshotsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.OrderLockHouseBillSnapshotsTable,
	...
	if _u.mutation.IssuedSeaHouseBillVersionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedIssuedSeaHouseBillVersionsIDs(); len(nodes) > 0 && !_u.mutation.IssuedSeaHouseBillVersionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.IssuedSeaHouseBillVersionsTable,
	...
	if nodes := _u.mutation.IssuedSeaHouseBillVersionsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.IssuedSeaHouseBillVersionsTable,
	...
	if _u.mutation.DingtalkApprovalDispatchesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedDingtalkApprovalDispatchesIDs(); len(nodes) > 0 && !_u.mutation.DingtalkApprovalDispatchesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.DingtalkApprovalDispatchesTable,
	...
	if nodes := _u.mutation.DingtalkApprovalDispatchesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.DingtalkApprovalDispatchesTable,
	...
	if _u.mutation.SeaSharedContainersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedSeaSharedContainersIDs(); len(nodes) > 0 && !_u.mutation.SeaSharedContainersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.SeaSharedContainersTable,
	...
	if nodes := _u.mutation.SeaSharedContainersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.SeaSharedContainersTable,
	...
	if _u.mutation.SeaSharedContainerAllocationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedSeaSharedContainerAllocationsIDs(); len(nodes) > 0 && !_u.mutation.SeaSharedContainerAllocationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.SeaSharedContainerAllocationsTable,
	...
	if nodes := _u.mutation.SeaSharedContainerAllocationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.SeaSharedContainerAllocationsTable,
...
// AddSeaHouseBillIDs adds the "sea_house_bills" edge to the SeaHouseBill entity by IDs.
func (_u *OrganizationUpdateOne) AddSeaHouseBillIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddSeaHouseBillIDs(ids...)
	return _u
}

// AddSeaHouseBills adds the "sea_house_bills" edges to the SeaHouseBill entity.
func (_u *OrganizationUpdateOne) AddSeaHouseBills(v ...*SeaHouseBill) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddIssuedSeaHouseBillIDs adds the "issued_sea_house_bills" edge to the SeaHouseBill entity by IDs.
func (_u *OrganizationUpdateOne) AddIssuedSeaHouseBillIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddIssuedSeaHouseBillIDs(ids...)
	return _u
}

// AddIssuedSeaHouseBills adds the "issued_sea_house_bills" edges to the SeaHouseBill entity.
func (_u *OrganizationUpdateOne) AddIssuedSeaHouseBills(v ...*SeaHouseBill) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddOrderCargoItemIDs adds the "order_cargo_items" edge to the OrderCargoItem entity by IDs.
func (_u *OrganizationUpdateOne) AddOrderCargoItemIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddOrderCargoItemIDs(ids...)
	return _u
}

// AddOrderCargoItems adds the "order_cargo_items" edges to the OrderCargoItem entity.
func (_u *OrganizationUpdateOne) AddOrderCargoItems(v ...*OrderCargoItem) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddOrderContainerIDs adds the "order_containers" edge to the OrderContainer entity by IDs.
func (_u *OrganizationUpdateOne) AddOrderContainerIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddOrderContainerIDs(ids...)
	return _u
}

// AddOrderContainers adds the "order_containers" edges to the OrderContainer entity.
func (_u *OrganizationUpdateOne) AddOrderContainers(v ...*OrderContainer) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddFinanceCommissionRuleAssignmentIDs adds the "finance_commission_rule_assignments" edge to the FinanceCommissionRuleAssignment entity by IDs.
func (_u *OrganizationUpdateOne) AddFinanceCommissionRuleAssignmentIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddFinanceCommissionRuleAssignmentIDs(ids...)
	return _u
}

// AddFinanceCommissionRuleAssignments adds the "finance_commission_rule_assignments" edges to the FinanceCommissionRuleAssignment entity.
func (_u *OrganizationUpdateOne) AddFinanceCommissionRuleAssignments(v ...*FinanceCommissionRuleAssignment) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddFinanceCommissionApplicationIDs adds the "finance_commission_applications" edge to the FinanceCommissionApplication entity by IDs.
func (_u *OrganizationUpdateOne) AddFinanceCommissionApplicationIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddFinanceCommissionApplicationIDs(ids...)
	return _u
}

// AddFinanceCommissionApplications adds the "finance_commission_applications" edges to the FinanceCommissionApplication entity.
func (_u *OrganizationUpdateOne) AddFinanceCommissionApplications(v ...*FinanceCommissionApplication) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddFinanceCommissionApplicationLineIDs adds the "finance_commission_application_lines" edge to the FinanceCommissionApplicationLine entity by IDs.
func (_u *OrganizationUpdateOne) AddFinanceCommissionApplicationLineIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddFinanceCommissionApplicationLineIDs(ids...)
	return _u
}

// AddFinanceCommissionApplicationLines adds the "finance_commission_application_lines" edges to the FinanceCommissionApplicationLine entity.
func (_u *OrganizationUpdateOne) AddFinanceCommissionApplicationLines(v ...*FinanceCommissionApplicationLine) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddAttachmentAssetIDs adds the "attachment_assets" edge to the OrderAttachmentAsset entity by IDs.
func (_u *OrganizationUpdateOne) AddAttachmentAssetIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddAttachmentAssetIDs(ids...)
	return _u
}

// AddAttachmentAssets adds the "attachment_assets" edges to the OrderAttachmentAsset entity.
func (_u *OrganizationUpdateOne) AddAttachmentAssets(v ...*OrderAttachmentAsset) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSeaOrderSplitEventIDs adds the "sea_order_split_events" edge to the SeaOrderSplitEvent entity by IDs.
func (_u *OrganizationUpdateOne) AddSeaOrderSplitEventIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddSeaOrderSplitEventIDs(ids...)
	return _u
}

// AddSeaOrderSplitEvents adds the "sea_order_split_events" edges to the SeaOrderSplitEvent entity.
func (_u *OrganizationUpdateOne) AddSeaOrderSplitEvents(v ...*SeaOrderSplitEvent) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSeaOrderSplitResultIDs adds the "sea_order_split_results" edge to the SeaOrderSplitResult entity by IDs.
func (_u *OrganizationUpdateOne) AddSeaOrderSplitResultIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddSeaOrderSplitResultIDs(ids...)
	return _u
}

// AddSeaOrderSplitResults adds the "sea_order_split_results" edges to the SeaOrderSplitResult entity.
func (_u *OrganizationUpdateOne) AddSeaOrderSplitResults(v ...*SeaOrderSplitResult) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSeaOrderReassignmentEventIDs adds the "sea_order_reassignment_events" edge to the SeaOrderReassignmentEvent entity by IDs.
func (_u *OrganizationUpdateOne) AddSeaOrderReassignmentEventIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddSeaOrderReassignmentEventIDs(ids...)
	return _u
}

// AddSeaOrderReassignmentEvents adds the "sea_order_reassignment_events" edges to the SeaOrderReassignmentEvent entity.
func (_u *OrganizationUpdateOne) AddSeaOrderReassignmentEvents(v ...*SeaOrderReassignmentEvent) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddOrderLockRecordIDs adds the "order_lock_records" edge to the OrderLockRecord entity by IDs.
func (_u *OrganizationUpdateOne) AddOrderLockRecordIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddOrderLockRecordIDs(ids...)
	return _u
}

// AddOrderLockRecords adds the "order_lock_records" edges to the OrderLockRecord entity.
func (_u *OrganizationUpdateOne) AddOrderLockRecords(v ...*OrderLockRecord) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddOrderLockHouseBillSnapshots adds the "order_lock_house_bill_snapshots" edges to the OrderLockHouseBillSnapshot entity.
func (_u *OrganizationUpdateOne) AddOrderLockHouseBillSnapshots(v ...*OrderLockHouseBillSnapshot) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddOrderUnlockRequestIDs adds the "order_unlock_requests" edge to the OrderUnlockRequest entity by IDs.
func (_u *OrganizationUpdateOne) AddOrderUnlockRequestIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddOrderUnlockRequestIDs(ids...)
	return _u
}

// AddOrderUnlockRequests adds the "order_unlock_requests" edges to the OrderUnlockRequest entity.
func (_u *OrganizationUpdateOne) AddOrderUnlockRequests(v ...*OrderUnlockRequest) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSeaMasterBillVersionIDs adds the "sea_master_bill_versions" edge to the SeaMasterBillVersion entity by IDs.
func (_u *OrganizationUpdateOne) AddSeaMasterBillVersionIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddSeaMasterBillVersionIDs(ids...)
	return _u
}

// AddSeaMasterBillVersions adds the "sea_master_bill_versions" edges to the SeaMasterBillVersion entity.
func (_u *OrganizationUpdateOne) AddSeaMasterBillVersions(v ...*SeaMasterBillVersion) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSeaHouseBillVersionIDs adds the "sea_house_bill_versions" edge to the SeaHouseBillVersion entity by IDs.
func (_u *OrganizationUpdateOne) AddSeaHouseBillVersionIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddSeaHouseBillVersionIDs(ids...)
	return _u
}

// AddSeaHouseBillVersions adds the "sea_house_bill_versions" edges to the SeaHouseBillVersion entity.
func (_u *OrganizationUpdateOne) AddSeaHouseBillVersions(v ...*SeaHouseBillVersion) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddIssuedSeaHouseBillVersionIDs adds the "issued_sea_house_bill_versions" edge to the SeaHouseBillVersion entity by IDs.
func (_u *OrganizationUpdateOne) AddIssuedSeaHouseBillVersionIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddIssuedSeaHouseBillVersionIDs(ids...)
	return _u
}

// AddIssuedSeaHouseBillVersions adds the "issued_sea_house_bill_versions" edges to the SeaHouseBillVersion entity.
func (_u *OrganizationUpdateOne) AddIssuedSeaHouseBillVersions(v ...*SeaHouseBillVersion) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddDingtalkApprovalDispatchIDs adds the "dingtalk_approval_dispatches" edge to the DingTalkApprovalDispatch entity by IDs.
func (_u *OrganizationUpdateOne) AddDingtalkApprovalDispatchIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddDingtalkApprovalDispatchIDs(ids...)
	return _u
}

// AddDingtalkApprovalDispatches adds the "dingtalk_approval_dispatches" edges to the DingTalkApprovalDispatch entity.
func (_u *OrganizationUpdateOne) AddDingtalkApprovalDispatches(v ...*DingTalkApprovalDispatch) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSeaDocumentVoidEventIDs adds the "sea_document_void_events" edge to the SeaDocumentVoidEvent entity by IDs.
func (_u *OrganizationUpdateOne) AddSeaDocumentVoidEventIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddSeaDocumentVoidEventIDs(ids...)
	return _u
}

// AddSeaDocumentVoidEvents adds the "sea_document_void_events" edges to the SeaDocumentVoidEvent entity.
func (_u *OrganizationUpdateOne) AddSeaDocumentVoidEvents(v ...*SeaDocumentVoidEvent) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSeaTransportExecutionVersionIDs adds the "sea_transport_execution_versions" edge to the SeaTransportExecutionVersion entity by IDs.
func (_u *OrganizationUpdateOne) AddSeaTransportExecutionVersionIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddSeaTransportExecutionVersionIDs(ids...)
	return _u
}

// AddSeaTransportExecutionVersions adds the "sea_transport_execution_versions" edges to the SeaTransportExecutionVersion entity.
func (_u *OrganizationUpdateOne) AddSeaTransportExecutionVersions(v ...*SeaTransportExecutionVersion) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSeaDocumentModeChangeEventIDs adds the "sea_document_mode_change_events" edge to the SeaDocumentModeChangeEvent entity by IDs.
func (_u *OrganizationUpdateOne) AddSeaDocumentModeChangeEventIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddSeaDocumentModeChangeEventIDs(ids...)
	return _u
}

// AddSeaDocumentModeChangeEvents adds the "sea_document_mode_change_events" edges to the SeaDocumentModeChangeEvent entity.
func (_u *OrganizationUpdateOne) AddSeaDocumentModeChangeEvents(v ...*SeaDocumentModeChangeEvent) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSeaSharedContainerIDs adds the "sea_shared_containers" edge to the SeaSharedContainer entity by IDs.
func (_u *OrganizationUpdateOne) AddSeaSharedContainerIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddSeaSharedContainerIDs(ids...)
	return _u
}

// AddSeaSharedContainers adds the "sea_shared_containers" edges to the SeaSharedContainer entity.
func (_u *OrganizationUpdateOne) AddSeaSharedContainers(v ...*SeaSharedContainer) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSeaSharedContainerAllocationIDs adds the "sea_shared_container_allocations" edge to the SeaSharedContainerAllocation entity by IDs.
func (_u *OrganizationUpdateOne) AddSeaSharedContainerAllocationIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.AddSeaSharedContainerAllocationIDs(ids...)
	return _u
}

// AddSeaSharedContainerAllocations adds the "sea_shared_container_allocations" edges to the SeaSharedContainerAllocation entity.
func (_u *OrganizationUpdateOne) AddSeaSharedContainerAllocations(v ...*SeaSharedContainerAllocation) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSeaHouseBills clears all "sea_house_bills" edges to the SeaHouseBill entity.
func (_u *OrganizationUpdateOne) ClearSeaHouseBills() *OrganizationUpdateOne {
	_u.mutation.ClearSeaHouseBills()
	return _u
}

// RemoveSeaHouseBillIDs removes the "sea_house_bills" edge to SeaHouseBill entities by IDs.
func (_u *OrganizationUpdateOne) RemoveSeaHouseBillIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveSeaHouseBillIDs(ids...)
	return _u
}

// RemoveSeaHouseBills removes "sea_house_bills" edges to SeaHouseBill entities.
func (_u *OrganizationUpdateOne) RemoveSeaHouseBills(v ...*SeaHouseBill) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearIssuedSeaHouseBills clears all "issued_sea_house_bills" edges to the SeaHouseBill entity.
func (_u *OrganizationUpdateOne) ClearIssuedSeaHouseBills() *OrganizationUpdateOne {
	_u.mutation.ClearIssuedSeaHouseBills()
	return _u
}

// RemoveIssuedSeaHouseBillIDs removes the "issued_sea_house_bills" edge to SeaHouseBill entities by IDs.
func (_u *OrganizationUpdateOne) RemoveIssuedSeaHouseBillIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveIssuedSeaHouseBillIDs(ids...)
	return _u
}

// RemoveIssuedSeaHouseBills removes "issued_sea_house_bills" edges to SeaHouseBill entities.
func (_u *OrganizationUpdateOne) RemoveIssuedSeaHouseBills(v ...*SeaHouseBill) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearOrderCargoItems clears all "order_cargo_items" edges to the OrderCargoItem entity.
func (_u *OrganizationUpdateOne) ClearOrderCargoItems() *OrganizationUpdateOne {
	_u.mutation.ClearOrderCargoItems()
	return _u
}

// RemoveOrderCargoItemIDs removes the "order_cargo_items" edge to OrderCargoItem entities by IDs.
func (_u *OrganizationUpdateOne) RemoveOrderCargoItemIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveOrderCargoItemIDs(ids...)
	return _u
}

// RemoveOrderCargoItems removes "order_cargo_items" edges to OrderCargoItem entities.
func (_u *OrganizationUpdateOne) RemoveOrderCargoItems(v ...*OrderCargoItem) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearOrderContainers clears all "order_containers" edges to the OrderContainer entity.
func (_u *OrganizationUpdateOne) ClearOrderContainers() *OrganizationUpdateOne {
	_u.mutation.ClearOrderContainers()
	return _u
}

// RemoveOrderContainerIDs removes the "order_containers" edge to OrderContainer entities by IDs.
func (_u *OrganizationUpdateOne) RemoveOrderContainerIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveOrderContainerIDs(ids...)
	return _u
}

// RemoveOrderContainers removes "order_containers" edges to OrderContainer entities.
func (_u *OrganizationUpdateOne) RemoveOrderContainers(v ...*OrderContainer) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearFinanceCommissionRuleAssignments clears all "finance_commission_rule_assignments" edges to the FinanceCommissionRuleAssignment entity.
func (_u *OrganizationUpdateOne) ClearFinanceCommissionRuleAssignments() *OrganizationUpdateOne {
	_u.mutation.ClearFinanceCommissionRuleAssignments()
	return _u
}

// RemoveFinanceCommissionRuleAssignmentIDs removes the "finance_commission_rule_assignments" edge to FinanceCommissionRuleAssignment entities by IDs.
func (_u *OrganizationUpdateOne) RemoveFinanceCommissionRuleAssignmentIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveFinanceCommissionRuleAssignmentIDs(ids...)
	return _u
}

// RemoveFinanceCommissionRuleAssignments removes "finance_commission_rule_assignments" edges to FinanceCommissionRuleAssignment entities.
func (_u *OrganizationUpdateOne) RemoveFinanceCommissionRuleAssignments(v ...*FinanceCommissionRuleAssignment) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearFinanceCommissionApplications clears all "finance_commission_applications" edges to the FinanceCommissionApplication entity.
func (_u *OrganizationUpdateOne) ClearFinanceCommissionApplications() *OrganizationUpdateOne {
	_u.mutation.ClearFinanceCommissionApplications()
	return _u
}

// RemoveFinanceCommissionApplicationIDs removes the "finance_commission_applications" edge to FinanceCommissionApplication entities by IDs.
func (_u *OrganizationUpdateOne) RemoveFinanceCommissionApplicationIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveFinanceCommissionApplicationIDs(ids...)
	return _u
}

// RemoveFinanceCommissionApplications removes "finance_commission_applications" edges to FinanceCommissionApplication entities.
func (_u *OrganizationUpdateOne) RemoveFinanceCommissionApplications(v ...*FinanceCommissionApplication) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearFinanceCommissionApplicationLines clears all "finance_commission_application_lines" edges to the FinanceCommissionApplicationLine entity.
func (_u *OrganizationUpdateOne) ClearFinanceCommissionApplicationLines() *OrganizationUpdateOne {
	_u.mutation.ClearFinanceCommissionApplicationLines()
	return _u
}

// RemoveFinanceCommissionApplicationLineIDs removes the "finance_commission_application_lines" edge to FinanceCommissionApplicationLine entities by IDs.
func (_u *OrganizationUpdateOne) RemoveFinanceCommissionApplicationLineIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveFinanceCommissionApplicationLineIDs(ids...)
	return _u
}

// RemoveFinanceCommissionApplicationLines removes "finance_commission_application_lines" edges to FinanceCommissionApplicationLine entities.
func (_u *OrganizationUpdateOne) RemoveFinanceCommissionApplicationLines(v ...*FinanceCommissionApplicationLine) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearAttachmentAssets clears all "attachment_assets" edges to the OrderAttachmentAsset entity.
func (_u *OrganizationUpdateOne) ClearAttachmentAssets() *OrganizationUpdateOne {
	_u.mutation.ClearAttachmentAssets()
	return _u
}

// RemoveAttachmentAssetIDs removes the "attachment_assets" edge to OrderAttachmentAsset entities by IDs.
func (_u *OrganizationUpdateOne) RemoveAttachmentAssetIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveAttachmentAssetIDs(ids...)
	return _u
}

// RemoveAttachmentAssets removes "attachment_assets" edges to OrderAttachmentAsset entities.
func (_u *OrganizationUpdateOne) RemoveAttachmentAssets(v ...*OrderAttachmentAsset) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSeaOrderSplitEvents clears all "sea_order_split_events" edges to the SeaOrderSplitEvent entity.
func (_u *OrganizationUpdateOne) ClearSeaOrderSplitEvents() *OrganizationUpdateOne {
	_u.mutation.ClearSeaOrderSplitEvents()
	return _u
}

// RemoveSeaOrderSplitEventIDs removes the "sea_order_split_events" edge to SeaOrderSplitEvent entities by IDs.
func (_u *OrganizationUpdateOne) RemoveSeaOrderSplitEventIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveSeaOrderSplitEventIDs(ids...)
	return _u
}

// RemoveSeaOrderSplitEvents removes "sea_order_split_events" edges to SeaOrderSplitEvent entities.
func (_u *OrganizationUpdateOne) RemoveSeaOrderSplitEvents(v ...*SeaOrderSplitEvent) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSeaOrderSplitResults clears all "sea_order_split_results" edges to the SeaOrderSplitResult entity.
func (_u *OrganizationUpdateOne) ClearSeaOrderSplitResults() *OrganizationUpdateOne {
	_u.mutation.ClearSeaOrderSplitResults()
	return _u
}

// RemoveSeaOrderSplitResultIDs removes the "sea_order_split_results" edge to SeaOrderSplitResult entities by IDs.
func (_u *OrganizationUpdateOne) RemoveSeaOrderSplitResultIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveSeaOrderSplitResultIDs(ids...)
	return _u
}

// RemoveSeaOrderSplitResults removes "sea_order_split_results" edges to SeaOrderSplitResult entities.
func (_u *OrganizationUpdateOne) RemoveSeaOrderSplitResults(v ...*SeaOrderSplitResult) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSeaOrderReassignmentEvents clears all "sea_order_reassignment_events" edges to the SeaOrderReassignmentEvent entity.
func (_u *OrganizationUpdateOne) ClearSeaOrderReassignmentEvents() *OrganizationUpdateOne {
	_u.mutation.ClearSeaOrderReassignmentEvents()
	return _u
}

// RemoveSeaOrderReassignmentEventIDs removes the "sea_order_reassignment_events" edge to SeaOrderReassignmentEvent entities by IDs.
func (_u *OrganizationUpdateOne) RemoveSeaOrderReassignmentEventIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveSeaOrderReassignmentEventIDs(ids...)
	return _u
}

// RemoveSeaOrderReassignmentEvents removes "sea_order_reassignment_events" edges to SeaOrderReassignmentEvent entities.
func (_u *OrganizationUpdateOne) RemoveSeaOrderReassignmentEvents(v ...*SeaOrderReassignmentEvent) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearOrderLockRecords clears all "order_lock_records" edges to the OrderLockRecord entity.
func (_u *OrganizationUpdateOne) ClearOrderLockRecords() *OrganizationUpdateOne {
	_u.mutation.ClearOrderLockRecords()
	return _u
}

// RemoveOrderLockRecordIDs removes the "order_lock_records" edge to OrderLockRecord entities by IDs.
func (_u *OrganizationUpdateOne) RemoveOrderLockRecordIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveOrderLockRecordIDs(ids...)
	return _u
}

// RemoveOrderLockRecords removes "order_lock_records" edges to OrderLockRecord entities.
func (_u *OrganizationUpdateOne) RemoveOrderLockRecords(v ...*OrderLockRecord) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearOrderLockHouseBillSnapshots clears all "order_lock_house_bill_snapshots" edges to the OrderLockHouseBillSnapshot entity.
func (_u *OrganizationUpdateOne) ClearOrderLockHouseBillSnapshots() *OrganizationUpdateOne {
	_u.mutation.ClearOrderLockHouseBillSnapshots()
	return _u
}

// RemoveOrderLockHouseBillSnapshotIDs removes the "order_lock_house_bill_snapshots" edge to OrderLockHouseBillSnapshot entities by IDs.
func (_u *OrganizationUpdateOne) RemoveOrderLockHouseBillSnapshotIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveOrderLockHouseBillSnapshotIDs(ids...)
	return _u
}

// RemoveOrderLockHouseBillSnapshots removes "order_lock_house_bill_snapshots" edges to OrderLockHouseBillSnapshot entities.
func (_u *OrganizationUpdateOne) RemoveOrderLockHouseBillSnapshots(v ...*OrderLockHouseBillSnapshot) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearOrderUnlockRequests clears all "order_unlock_requests" edges to the OrderUnlockRequest entity.
func (_u *OrganizationUpdateOne) ClearOrderUnlockRequests() *OrganizationUpdateOne {
	_u.mutation.ClearOrderUnlockRequests()
	return _u
}

// RemoveOrderUnlockRequestIDs removes the "order_unlock_requests" edge to OrderUnlockRequest entities by IDs.
func (_u *OrganizationUpdateOne) RemoveOrderUnlockRequestIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveOrderUnlockRequestIDs(ids...)
	return _u
}

// RemoveOrderUnlockRequests removes "order_unlock_requests" edges to OrderUnlockRequest entities.
func (_u *OrganizationUpdateOne) RemoveOrderUnlockRequests(v ...*OrderUnlockRequest) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSeaMasterBillVersions clears all "sea_master_bill_versions" edges to the SeaMasterBillVersion entity.
func (_u *OrganizationUpdateOne) ClearSeaMasterBillVersions() *OrganizationUpdateOne {
	_u.mutation.ClearSeaMasterBillVersions()
	return _u
}

// RemoveSeaMasterBillVersionIDs removes the "sea_master_bill_versions" edge to SeaMasterBillVersion entities by IDs.
func (_u *OrganizationUpdateOne) RemoveSeaMasterBillVersionIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveSeaMasterBillVersionIDs(ids...)
	return _u
}

// RemoveSeaMasterBillVersions removes "sea_master_bill_versions" edges to SeaMasterBillVersion entities.
func (_u *OrganizationUpdateOne) RemoveSeaMasterBillVersions(v ...*SeaMasterBillVersion) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSeaHouseBillVersions clears all "sea_house_bill_versions" edges to the SeaHouseBillVersion entity.
func (_u *OrganizationUpdateOne) ClearSeaHouseBillVersions() *OrganizationUpdateOne {
	_u.mutation.ClearSeaHouseBillVersions()
	return _u
}

// RemoveSeaHouseBillVersionIDs removes the "sea_house_bill_versions" edge to SeaHouseBillVersion entities by IDs.
func (_u *OrganizationUpdateOne) RemoveSeaHouseBillVersionIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveSeaHouseBillVersionIDs(ids...)
	return _u
}

// RemoveSeaHouseBillVersions removes "sea_house_bill_versions" edges to SeaHouseBillVersion entities.
func (_u *OrganizationUpdateOne) RemoveSeaHouseBillVersions(v ...*SeaHouseBillVersion) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearIssuedSeaHouseBillVersions clears all "issued_sea_house_bill_versions" edges to the SeaHouseBillVersion entity.
func (_u *OrganizationUpdateOne) ClearIssuedSeaHouseBillVersions() *OrganizationUpdateOne {
	_u.mutation.ClearIssuedSeaHouseBillVersions()
	return _u
}

// RemoveIssuedSeaHouseBillVersionIDs removes the "issued_sea_house_bill_versions" edge to SeaHouseBillVersion entities by IDs.
func (_u *OrganizationUpdateOne) RemoveIssuedSeaHouseBillVersionIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveIssuedSeaHouseBillVersionIDs(ids...)
	return _u
}

// RemoveIssuedSeaHouseBillVersions removes "issued_sea_house_bill_versions" edges to SeaHouseBillVersion entities.
func (_u *OrganizationUpdateOne) RemoveIssuedSeaHouseBillVersions(v ...*SeaHouseBillVersion) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearDingtalkApprovalDispatches clears all "dingtalk_approval_dispatches" edges to the DingTalkApprovalDispatch entity.
func (_u *OrganizationUpdateOne) ClearDingtalkApprovalDispatches() *OrganizationUpdateOne {
	_u.mutation.ClearDingtalkApprovalDispatches()
	return _u
}

// RemoveDingtalkApprovalDispatchIDs removes the "dingtalk_approval_dispatches" edge to DingTalkApprovalDispatch entities by IDs.
func (_u *OrganizationUpdateOne) RemoveDingtalkApprovalDispatchIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveDingtalkApprovalDispatchIDs(ids...)
	return _u
}

// RemoveDingtalkApprovalDispatches removes "dingtalk_approval_dispatches" edges to DingTalkApprovalDispatch entities.
func (_u *OrganizationUpdateOne) RemoveDingtalkApprovalDispatches(v ...*DingTalkApprovalDispatch) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSeaDocumentVoidEvents clears all "sea_document_void_events" edges to the SeaDocumentVoidEvent entity.
func (_u *OrganizationUpdateOne) ClearSeaDocumentVoidEvents() *OrganizationUpdateOne {
	_u.mutation.ClearSeaDocumentVoidEvents()
	return _u
}

// RemoveSeaDocumentVoidEventIDs removes the "sea_document_void_events" edge to SeaDocumentVoidEvent entities by IDs.
func (_u *OrganizationUpdateOne) RemoveSeaDocumentVoidEventIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveSeaDocumentVoidEventIDs(ids...)
	return _u
}

// RemoveSeaDocumentVoidEvents removes "sea_document_void_events" edges to SeaDocumentVoidEvent entities.
func (_u *OrganizationUpdateOne) RemoveSeaDocumentVoidEvents(v ...*SeaDocumentVoidEvent) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSeaTransportExecutionVersions clears all "sea_transport_execution_versions" edges to the SeaTransportExecutionVersion entity.
func (_u *OrganizationUpdateOne) ClearSeaTransportExecutionVersions() *OrganizationUpdateOne {
	_u.mutation.ClearSeaTransportExecutionVersions()
	return _u
}

// RemoveSeaTransportExecutionVersionIDs removes the "sea_transport_execution_versions" edge to SeaTransportExecutionVersion entities by IDs.
func (_u *OrganizationUpdateOne) RemoveSeaTransportExecutionVersionIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveSeaTransportExecutionVersionIDs(ids...)
	return _u
}

// RemoveSeaTransportExecutionVersions removes "sea_transport_execution_versions" edges to SeaTransportExecutionVersion entities.
func (_u *OrganizationUpdateOne) RemoveSeaTransportExecutionVersions(v ...*SeaTransportExecutionVersion) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSeaDocumentModeChangeEvents clears all "sea_document_mode_change_events" edges to the SeaDocumentModeChangeEvent entity.
func (_u *OrganizationUpdateOne) ClearSeaDocumentModeChangeEvents() *OrganizationUpdateOne {
	_u.mutation.ClearSeaDocumentModeChangeEvents()
	return _u
}

// RemoveSeaDocumentModeChangeEventIDs removes the "sea_document_mode_change_events" edge to SeaDocumentModeChangeEvent entities by IDs.
func (_u *OrganizationUpdateOne) RemoveSeaDocumentModeChangeEventIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveSeaDocumentModeChangeEventIDs(ids...)
	return _u
}

// RemoveSeaDocumentModeChangeEvents removes "sea_document_mode_change_events" edges to SeaDocumentModeChangeEvent entities.
func (_u *OrganizationUpdateOne) RemoveSeaDocumentModeChangeEvents(v ...*SeaDocumentModeChangeEvent) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSeaSharedContainers clears all "sea_shared_containers" edges to the SeaSharedContainer entity.
func (_u *OrganizationUpdateOne) ClearSeaSharedContainers() *OrganizationUpdateOne {
	_u.mutation.ClearSeaSharedContainers()
	return _u
}

// RemoveSeaSharedContainerIDs removes the "sea_shared_containers" edge to SeaSharedContainer entities by IDs.
func (_u *OrganizationUpdateOne) RemoveSeaSharedContainerIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveSeaSharedContainerIDs(ids...)
	return _u
}

// RemoveSeaSharedContainers removes "sea_shared_containers" edges to SeaSharedContainer entities.
func (_u *OrganizationUpdateOne) RemoveSeaSharedContainers(v ...*SeaSharedContainer) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSeaSharedContainerAllocations clears all "sea_shared_container_allocations" edges to the SeaSharedContainerAllocation entity.
func (_u *OrganizationUpdateOne) ClearSeaSharedContainerAllocations() *OrganizationUpdateOne {
	_u.mutation.ClearSeaSharedContainerAllocations()
	return _u
}

// RemoveSeaSharedContainerAllocationIDs removes the "sea_shared_container_allocations" edge to SeaSharedContainerAllocation entities by IDs.
func (_u *OrganizationUpdateOne) RemoveSeaSharedContainerAllocationIDs(ids ...uuid.UUID) *OrganizationUpdateOne {
	_u.mutation.RemoveSeaSharedContainerAllocationIDs(ids...)
	return _u
}

// RemoveSeaSharedContainerAllocations removes "sea_shared_container_allocations" edges to SeaSharedContainerAllocation entities.
func (_u *OrganizationUpdateOne) RemoveSeaSharedContainerAllocations(v ...*SeaSharedContainerAllocation) *OrganizationUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
