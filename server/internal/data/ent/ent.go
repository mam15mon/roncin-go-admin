...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			enterpriseresourceassignee.Table:       enterpriseresourceassignee.ValidColumn,
			enterpriseresourceimage.Table:          enterpriseresourceimage.ValidColumn,
			enterpriseresourcepartner.Table:        enterpriseresourcepartner.ValidColumn,
			enterpriseresourceparty.Table:          enterpriseresourceparty.ValidColumn,
			enterpriseresourceremark.Table:         enterpriseresourceremark.ValidColumn,
			...
			feesettingtemplate.Table:               feesettingtemplate.ValidColumn,
			...
			financecommissionapplication.Table:     financecommissionapplication.ValidColumn,
			financecommissionapplicationline.Table: financecommissionapplicationline.ValidColumn,
