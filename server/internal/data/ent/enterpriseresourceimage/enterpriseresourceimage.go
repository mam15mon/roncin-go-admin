...
const (
	// Label holds the string label denoting the enterpriseresourceimage type in the database.
	Label = "enterprise_resource_image"
	...
	// Table holds the table name of the enterpriseresourceimage in the database.
	Table = "enterprise_resource_images"
	// ResourceTable is the table that holds the resource relation/edge.
	ResourceTable = "enterprise_resource_images"
	...
	UploaderTable = "enterprise_resource_images"
...
// Columns holds all SQL columns for enterpriseresourceimage fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the EnterpriseResourceImage queries.
