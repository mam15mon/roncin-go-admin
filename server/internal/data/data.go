...
var ProviderSet = wire.NewSet(NewData, NewEnterpriseImageStorage, NewEnterpriseResourceRepo, NewBusinessTagRepo, NewAuthRepo, NewWeComIdentityProvider, dingTalkProviderSet, NewPartnerRepo, NewPartnerAccountRepo, NewPartnerContractRepo, NewPartnerSettlementRuleRepo, NewPartnerAttachmentRepo, NewPartnerShippingPresetRepo, NewPartnerInvoiceProfileRepo, NewAdminRepo, NewMasterDataRepo, NewIndustryReferenceRepo, NewReferenceDataRepo, NewOrderConfigRepo, NewOrderRepo, NewSeaMasterBillRepo, NewSeaDocumentRepo, NewOrderMilestoneRepo, NewOrderAttachmentRepo, NewOrderPersonnelRepo, NewOrderContainerRepo, NewOrderCargoItemRepo, NewOrderShippingDocumentRepo, NewOrderReleasePodRepo, NewOrderAbnormalCaseRepo, NewExchangeRateRepo, NewFeeCatalogRepo, NewOrderFeeRepo, NewSettlementRepo, NewFeeLedgerPreferenceRepo, NewFinanceCustomSettingRepo, NewFinanceBillRepo, NewFinanceInvoiceRepo, NewFinanceCashflowRepo, NewVerificationRepo, NewCommissionRepo, NewBackgroundTaskRepo, NewNotificationRepo, NewObjectDeletionRepo, wire.Bind(new(biz.Transactor), new(*Data)))
