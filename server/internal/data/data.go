...
var ProviderSet = wire.NewSet(NewData, NewEnterpriseImageStorage, NewEnterpriseResourceRepo, NewBusinessTagRepo, NewAuthRepo, NewWeComIdentityProvider, dingTalkProviderSet, NewPartnerRepo, NewPartnerAccountRepo, NewPartnerContractRepo, NewPartnerSettlementRuleRepo, NewPartnerAttachmentRepo, NewPartnerShippingPresetRepo, NewPartnerInvoiceProfileRepo, NewAdminRepo, NewMasterDataRepo, NewIndustryReferenceRepo, NewReferenceDataRepo, NewOrderConfigRepo, NewOrderRepo, NewOrderLockRepo, NewAutoOrderLockRepo, NewSeaMasterBillRepo, NewSeaDocumentRepo, NewSeaDocumentChangeRepo, NewSeaSharedContainerRepo, NewSeaOrderChangeRepo, NewOrderMilestoneRepo, NewOrderAttachmentRepo, NewOrderPersonnelRepo, NewOrderContainerRepo, NewOrderCargoItemRepo, NewOrderShippingDocumentRepo, NewOrderReleasePodRepo, NewOrderAbnormalCaseRepo, NewExchangeRateRepo, NewExchangeRateQuoteProvider, NewExchangeRateReminderRepo, NewFeeCatalogRepo, NewOrderFeeRepo, NewSettlementRepo, NewFeeLedgerPreferenceRepo, NewFinanceCustomSettingRepo, NewFinanceBillRepo, NewFinanceInvoiceRepo, NewFinanceCashflowRepo, NewVerificationRepo, NewFinanceNettingRepo, NewCommissionRepo, NewBackgroundTaskRepo, NewNotificationRepo, NewDingTalkApprovalRepo, NewObjectDeletionRepo, wire.Bind(new(biz.PartnerCreditRepo), new(biz.FinanceBillRepo)), wire.Bind(new(biz.Transactor), new(*Data)))
