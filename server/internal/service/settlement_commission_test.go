...
func newCommissionService(org uuid.UUID) (*SettlementService, *commissionRepoStub) {
	...
	service := NewSettlementService(nil, nil, nil, nil, verificationUsecase, usecase, nil, nil, nil)
	return service, repo
}
...
func TestListCommissionVerificationCandidatesUsesManageWritableOrganization(t *testing.T) {
	...
	service := NewSettlementService(nil, nil, nil, nil, biz.NewVerificationUsecase(repo, nil, nil), nil, nil, nil, nil)
