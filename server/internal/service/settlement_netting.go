...
func financeNettingToAPI(item *biz.FinanceNetting) *v1.FinanceNetting {
	...
	return &v1.FinanceNetting{
		...
		BaseCurrencyAmount: item.BaseCurrencyAmount.StringFixed(8), PayableBaseAmount: item.PayableBaseAmount.StringFixed(8),
		ExchangeGainLoss: item.ExchangeGainLoss.StringFixed(8), Note: item.Note, Version: item.Version,
