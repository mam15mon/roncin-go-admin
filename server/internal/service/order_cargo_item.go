...
func orderCargoItemInputFromAPI(orderIDText, cargoName string, packageCount int32, grossWeightKg, volumeCbm, netWeightKg float64, note string) (uuid.UUID, *biz.OrderCargoItem, error) {
...
var _ v1.OrderCargoItemServiceServer = (*OrderCargoItemService)(nil)
