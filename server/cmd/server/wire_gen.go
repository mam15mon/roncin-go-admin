...
func wireApp(confServer *conf.Server, confData *conf.Data, security *conf.Security, logger *slog.Logger) (*kratos.App, func(), error) {
	...
	financeCashflowUsecase := biz.NewFinanceCashflowUsecase(financeCashflowRepo)
	verificationRepo := data.NewVerificationRepo(dataData)
	verificationUsecase := biz.NewVerificationUsecase(verificationRepo)
	...
	settlementService := service.NewSettlementService(settlementUsecase, financeBillUsecase, financeInvoiceUsecase, financeCashflowUsecase, verificationUsecase, commissionUsecase, feeLedgerPreferenceUsecase)
