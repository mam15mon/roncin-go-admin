...
func wireApp(confServer *conf.Server, confData *conf.Data, security *conf.Security, logger *slog.Logger) (*kratos.App, func(), error) {
	...
	orderFeeUsecase := biz.NewOrderFeeUsecase(orderFeeRepo, exchangeRateUsecase, financeCustomSettingUsecase, partnerCreditUsecase)
	...
	financeNettingUsecase := biz.NewFinanceNettingUsecase(financeNettingRepo, dataData)
