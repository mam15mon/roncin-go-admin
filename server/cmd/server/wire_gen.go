...
func wireApp(confServer *conf.Server, confData *conf.Data, security *conf.Security, logger *slog.Logger) (*kratos.App, func(), error) {
	...
	grpcServer := server.NewGRPCServer(confServer, enterpriseResourceService, authService, partnerService, adminService, masterDataService, orderService, orderMilestoneService, orderAttachmentService, orderPersonnelService, backgroundTaskService, orderContainerService, orderCargoItemService, orderShippingDocumentService, seaDocumentService, seaCargoAllocationService, seaOrderChangeService, orderAbnormalCaseService, orderReleasePodService, exchangeRateService, feeCatalogService, orderFeeService, settlementService, authUsecase, orderUsecase, sessionPolicy, logger, orderTagService)
	httpServer := server.NewHTTPServer(confServer, enterpriseResourceService, authService, partnerService, adminService, masterDataService, orderService, orderTagService, orderMilestoneService, orderAttachmentService, orderPersonnelService, backgroundTaskService, orderContainerService, orderCargoItemService, orderShippingDocumentService, seaDocumentService, seaCargoAllocationService, seaOrderChangeService, orderAbnormalCaseService, orderReleasePodService, exchangeRateService, feeCatalogService, orderFeeService, settlementService, authUsecase, orderUsecase, sessionPolicy, dataData, logger)
